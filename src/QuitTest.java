...
public class QuitTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("Enter your first name or Quit to end the program.");
		...
		System.out.println("Enter your last name or Quit to end the program.");
		String lastName = input.nextLine();
		if (lastName.equalsIgnoreCase("quit")) {
			System.out.println("Nobody likes a quitter...");
			System.exit(0);

		System.out.println("Enter your age or Quit to end the program.");
		int age = input.nextInt();
		
		System.out.println("Enter your birth month number 1-12.");
		int birthMonth = input.nextInt();

		System.out.println("Enter your favorite ROYGBIV color. If you don't know what a ROYGBIV color is enter \"Help.\"");
			...
			if (color.equalsIgnoreCase("red") || color.equalsIgnoreCase("orange") || color.equalsIgnoreCase("yellow")
				...
				color = input.next();
				if (color.equalsIgnoreCase("red") || color.equalsIgnoreCase("orange")
						|| color.equalsIgnoreCase("yellow") || color.equalsIgnoreCase("green")
						|| color.equalsIgnoreCase("blue") || color.equalsIgnoreCase("indigo")
